  ...
  const plans = [
    {
      ...
      features: [
        { text: '10 AI extractions per month', included: true },
    ...
    },
    {
      ...
      features: [
        { text: 'Unlimited AI extractions', included: true },
        { text: 'Client management', included: true },
        { text: 'Invoice organization', included: true },
        { text: 'PDF generation', included: true },
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900 dark:text-[#E2E8F0]">
            Simple, <span className="bg-gradient-to-r from-[#6366F1] to-[#14B8A6] bg-clip-text text-transparent">Transparent</span> Pricing
          </h2>
            ...
            >
              ...
              <CardHeader>
                ...
                <div className="mt-4">
                  ...
                  {plan.period && (
                    <span className="text-gray-600 dark:text-[#E2E8F0]/60">{plan.period}</span>
                  )}
                </div>
              </CardHeader>
